...
import { CustomCheckBox, CustomInput } from "../../common/Inputs";
...
function MenuTable({
  ...
  return (
    <Table className="custom-table ">
      <TableCaption>
        {`A list of  ${isSelected ? "selected" : "other course"} videos`}
...
interface Props {
  ...
  newelySelected: videoType[];
  setNewelySelected: React.Dispatch<React.SetStateAction<videoType[]>>;
  alreadySelected: { _id: string; title: string; description: string }[];
  handleSubmit: () => void;
...
export default SuggestedVideoMenu;
